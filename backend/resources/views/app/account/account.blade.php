...
<div class="flex flex-col items-center justify-center w-full h-full">
    ...
    <img class="w-32 h-32 rounded-full mt-4" src="{{asset('storage/' . $user->profile->avatar) }}" alt="Profile photo">
    @else
    <img class="w-32 h-32 rounded-full mt-4" src="{{ asset('images/avatar profile.jpg') }}" alt=" image">
    @endif
</div>
@endsection
    ...
    <div id="editAccountInfos" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-xl max-h-full">
            ...
            <div class="relative bg-white rounded-xl shadow-xl animate-fadeIn">
                ...
                <div class="p-6">
                    <form action="{{ url('/app/account-settings/update') }}" method="POST">
                        @csrf
                        @method('PUT')
