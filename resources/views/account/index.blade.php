    ...
    <div class=" rounded-lg dark:border-gray-600 flex flex-col overflow-hidden">
        ...
        <div class="flex-1 px-3 py-1.5  ">
            <div class="flex flex-col items-center justify-center w-full h-full">
                ...
                <p class="text-gray-600">Welcome to your account settings page!</p>
                ...
                <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-10 relative">
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-6 relative z-10">
                        ...
                        <div class="text-center md:text-left text-white">
                            ...
                            <p class="text-indigo-100 mt-2 opacity-80">Last updated:
                                {{$user->created_at->format("D M Y")}}</p>
                        </div>

                        <!-- Edit button repositioned and restyled -->
                        <div class="md:ml-auto">
                            <button type="button" data-modal-target="editAccountInfos"
                                data-modal-toggle="editAccountInfos"
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        <label for="current_password"
                                            class="block mb-2 text-sm font-medium text-gray-700">Current
                                            Password</label>
                                        <div class="relative">
                                            <div
                                                class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                    ...
                                    <div>
                                        <label for="new_password"
                                            class="block mb-2 text-sm font-medium text-gray-700">New
                                            Password</label>
                                        <div class="relative">
                                            <div
                                                class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                    ...
                                    <div>
                                        <label for="confirm_password"
                                            class="block mb-2 text-sm font-medium text-gray-700">Confirm New
                                            Password</label>
                                        <div class="relative">
                                            <div
                                                class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
